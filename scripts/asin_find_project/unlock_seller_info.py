...
config = asyncio.run(set_cookie_main('13724333803'))
print(config)
DEFAULT_COOKIES['rank-login-user'] = config['rank-login-user']
DEFAULT_COOKIES['rank-login-user-info'] = config['rank-login-user-info']
...
def activate_children(
    ...
    if q_status != 200:
        print("   登录态异常，请更新 Cookie / Sprite-X-Token 后重试")
        return
